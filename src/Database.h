...
public:
    ...
    /**
     * removes response, exposure, vignette for the last traced frame and returns the image.
     */
    ...
    */
    ...
    /**
     * total no of features in the current frame backtracked across all frames.
     */
    long int total_tracked_features;
    
    /**
     * total exposure time for the current frame bactracked across all frames.
     */
    long double total_exposure_time; 
